...
void trap_return0(trapframe *tf) gcc_noreturn;
void trap_return1(trapframe *tf) gcc_noreturn;
void trap_return2(trapframe *tf) gcc_noreturn;
void trap_return3(trapframe *tf) gcc_noreturn;
