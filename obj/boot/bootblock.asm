...
protcseg:
  ...
  call bootmain
    7c45:	e8 d8 00 00 00       	call   7d22 <bootmain>
...
bootmain(void)
{
    ...
    7d42:	45 4c 46 
    7d45:	75 3f                	jne    7d86 <bootmain+0x64>
		goto bad;
	...
	for (; ph < eph; ph++)
    7d60:	eb 14                	jmp    7d76 <bootmain+0x54>
    ...
    7d78:	72 e8                	jb     7d62 <bootmain+0x40>
		readseg(ph->p_va, ph->p_memsz, ph->p_offset);
...
outw(int port, uint16_t data)
{
    ...
    7d99:	eb fe                	jmp    7d99 <bootmain+0x77>
